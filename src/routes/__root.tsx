...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Reelist — A cinephile's diary" },
      { name: "description", content: "Discover, track and celebrate the films you love." },
      { name: "author", content: "Reelist" },
      { property: "og:title", content: "Reelist — A cinephile's diary" },
